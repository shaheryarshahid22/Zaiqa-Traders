...
export default function FoodGelColors() {
        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Food Colors, Gel Colors & Dusts Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                     Shop food colors, gel colors, luster dusts, and <strong>edible</strong> paints in Pakistan. Perfect for vibrant cake decorating and <strong>sugar</strong> art.
                    </p>
                </div>
