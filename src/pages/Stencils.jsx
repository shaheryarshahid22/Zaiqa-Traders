        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Cake & Cookie Stencils Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                     Create <strong>stunning</strong> designs with cake and cookie stencils in Pakistan. Perfect for dusting, airbrushing, and <strong>royal icing</strong> work.
                    </p>
                </div>
