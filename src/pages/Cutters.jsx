        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Biscuit & Cookie Cutters Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                      Browse biscuit and cookie <strong>cutters</strong> in Pakistan in fun shapes and sizes. Great for themed baking, kids’ treats, <br/>and <strong>holiday</strong> cookies.
                    </p>
                </div>
