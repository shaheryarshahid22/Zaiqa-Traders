...
export default function CakeStands() {
    ...
    return (
        <div className="min-h-screen bg-gray-10">
            ...
            <section className="relative h-screen overflow-hidden">
                ...
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('cake_stands/cake_stands_background_image.jpg')" }}>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Cake Stands for Display in Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                       Elevate your cakes with <strong>elegant</strong> cake stands in Pakistan. Choose from rotating, acrylic, and metal stands perfect for <br />
                         <strong>presentation</strong> and parties.
                    </p>
                </div>
