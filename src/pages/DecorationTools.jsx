...
export default function DecorationTools() {
        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Cake Decorating Tools Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                      Buy professional cake decorating tools in Pakistan including spatulas, turntables, combs, and more for smooth and <br/><strong>creative</strong> cake finishes.
                    </p>
                </div>
