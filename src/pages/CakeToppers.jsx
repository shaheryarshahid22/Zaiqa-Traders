        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Birthday & Custom Cake Toppers Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                        Discover unique <strong>birthday</strong> and custom cake toppers in Pakistan. Add a personalized touch to your  <strong>cakes</strong> with themed, glitter, or <br />
                        name toppers.
                    </p>
                </div>
