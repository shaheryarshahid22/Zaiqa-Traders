        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Non-Stick Bakeware in Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                        Shop <strong>premium</strong> non-stick bakeware in Pakistan for perfect baking every time. Discover cake pans, muffin trays, and more for <br />
                        hassle-free <strong>baking</strong> at home or professionally.
                    </p>
                </div>
