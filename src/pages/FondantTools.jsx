...
export default function FondantTools() {
    ...
    return (
        <div className="min-h-screen bg-gray-10">
            ...
            <section className="relative h-screen overflow-hidden">
                ...
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('fondant_tools/fondant_tools_background_image.jpg')" }}>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Fondant Tools & Cutters in Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                       Find <strong>high-quality</strong> fondant tools and cutters in Pakistan for smooth and creative cake decorating. Ideal for  <strong>themed</strong> cakes and <br />
                        sugar craft.
                    </p>
                </div>
