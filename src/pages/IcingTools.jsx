...
export default function IcingTools() {
        ...
        <div className="min-h-screen bg-gray-10">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold text-gray-900">Piping Nozzles & Icing Tools Pakistan</h2>
                    <p className="text-lg text-gray-600 mt-4">
                      Buy piping nozzles, icing bags, and <strong>decorating</strong> tools in Pakistan. Create stunning designs with professional-grade <br/> <strong>icing</strong> supplies.
                    </p>
                </div>
