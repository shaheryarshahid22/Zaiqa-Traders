    ...
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-30 mt-50">
        <div className="relative">
          {/* Share Options */}
          <div
            className={`absolute left-0 bottom-20 transition-all duration-300 ${
              shareOpen
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`relative z-10 w-9 h-9 rounded-full flex items-center justify-center shadow-lg transition-all transform ${
                shareOpen
